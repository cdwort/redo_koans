...
It was the worst of times.
EOS
# Okay, so why is this one character less than the previous one? @#$
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Also, why does the shovel operator modify but not the plus equals?  What's the 
    # theory behind this syntax?
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # /me why on earth would I be surprised?  wtf.
  end
