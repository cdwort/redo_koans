...
class AboutSymbols < EdgeCase::Koan
  ...
  # --
  # /me Because symbols are created when file is initially parsed.  If
  # you declare the symbol for comparison purposes, then of course it 
  # exists.
  in_ruby_version("mri") do
    RubyConstant = "What is the sound of one hand clapping?"
    def test_constants_become_symbols
      # Alright, if the above is true, then why did I have to modify this section
      # to use strings?
      all_symbols_as_strings = Symbol.all_symbols.map{ |s| s.to_s}
  ...
  def test_symbols_with_spaces_can_be_built
    ...
    # But how are they referenced? As it turns out:
    # :"cats and dogs"
  end
